    ...
    <Link 
      ...
      <div>
        ...
        <div className="flex flex-col text-sm">
          <p className="hover:bg-zinc-200 dark:hover:bg-[#A1A1A1] rounded-sm px-2">My Open Issues</p>
          <p className="hover:bg-zinc-200 dark:hover:bg-[#A1A1A1] rounded-sm px-2">Done Issues</p>
        </div>
      </div>
    </Link>
  );
